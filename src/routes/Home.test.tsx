...
describe("Home", () => {
  it("should display correct result for given form values", () => {
    ...
    fireEvent.change(finCarPrice, { value: "56000" });
    fireEvent.change(finInitialPayment, { value: "754,5" });
    fireEvent.change(finRuntime, { value: "48" });
    fireEvent.change(finMonthlyRate, { value: "512,6" });
    fireEvent.change(finEndingRate, { value: "26320" });
    fireEvent.change(leasCarPrice, { value: "56000" });
    fireEvent.change(leasInitialPayment, { value: "754,5" });
    fireEvent.change(leasRuntime, { value: "48" });
    fireEvent.change(leasMonthlyRate, { value: "544,76" });
